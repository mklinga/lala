...
<html>
	...
	<body>
		<div id="content" >
			...
			<div id="main_pic"> <?php main_pic("taustaa_pic.jpg"); ?> </div>
			<div class="bottom_part">
				<div id="logo"> 
					<div id="sub_links"> <?php nav_links_toiminta("kohtaamisia"); ?> </div>
					<?php logo(); ?> 
				</div>
				<div id="text">
					<p>
					<strong>Huom! Yksityisyyden säilyttämiseksi henkilöiden nimet on muutettu.</strong>
					</p><p>
					Kohtaamisia: Sivu 1 <a href="kohtaamisia2.php">Sivu 2</a>
					</p><p>
					<h3>Kreeta</h3>
					<p class="kohtaaminen">
